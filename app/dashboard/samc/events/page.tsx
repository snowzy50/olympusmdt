/**
 * Page des événements SAMC - Interface moderne avec Realtime
 * Créé par: Snowzy
 */
...
export default function SAMCEventsPage() {
  const {
    events,
    isLoading,
    error,
        ...
        >
          <div className="space-y-2">
            <h1 className="text-3xl md:text-5xl font-extrabold bg-gradient-to-r from-white via-gray-100 to-gray-300 bg-clip-text text-transparent flex items-center gap-4">
              <div className="p-3 bg-gradient-to-br from-red-500 to-red-700 rounded-2xl shadow-lg shadow-red-500/20">
          ...
          <div className="flex items-center gap-4">
            ...
            <motion.button
              ...
              className="flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-red-600 via-red-500 to-red-600 hover:from-red-700 hover:via-red-600 hover:to-red-700 text-white rounded-xl font-bold shadow-lg shadow-red-500/30 transition-all"
            >
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex gap-2 flex-wrap">
              <select
                ...
                className="px-3 py-2 bg-gray-800 border border-gray-600 rounded-lg text-white text-sm focus:outline-none focus:ring-2 focus:ring-red-500"
              >
        ...
        >
          ...
          {isLoading ? (
            ...
            <div className="bg-gray-900/50 border border-gray-700 rounded-xl p-12 text-center">
              ...
              <button
                onClick={handleCreateEvent}
                className="px-6 py-3 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white rounded-lg font-semibold transition-all"
              >
